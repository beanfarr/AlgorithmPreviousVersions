    ...
    car_parks = [
        {
            ...
            'handicapped_space': False,
            'family_space': True,
            'ev_charging_space': True
        },
        {
            'name': 'Bravo',
            'time_to_carpark': 8,
...
def main():
    ...
    user_weights = {
        ...
        'traffic_density': 0.3,
        'carpark_availability': 0.5,
        'handicapped_space': 0.3,
        'family_space': 0.4,
        'ev_charging_space': 0.2
    }
    ...
    criteria = ['time_to_carpark', 'time_from_carpark', 'traffic_density', 'carpark_availability', 'handicapped_space', 'family_space', 'ev_charging_space']
